...
class UserController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        $user = User::where('document',$request->document)->whereNull("users.deleted_at")->with("role")->first();
        try {
    ...
    public function valid()
    {
        ...
        public function find(Request $request) {
            ...
            if($userRole->id!=$user->role_id){
                $data = User::where('document',$request->document)->whereNull("users.deleted_at")->where("role_id",$userRole->id);
                $data = $data->first();
            }
            return response()->json([
        ...
        public function recover(Request $request) {
            ...
            $data = User::where('document',$request->document)->whereNull("users.deleted_at")->where('email',$request->email)->first();
            $success = false;
    ...
    public function init(Request $request) {
        ...
        $data = User::where('document',$request->document)->whereNull("users.deleted_at")->first();
        $exist = !is_null($data);
        $success = false;
    ...
    public function demographic_report($user_id,$created_user_at){
        $demographics = User::select("d.user_id","users.id as userid","loc.name as birthdate_place","locr.name as city")->whereNull("users.deleted_at")
    ...
    public function unity_report($user_id,$created_user_at){
        $unity = User::select("unity.user_id","users.id as userid")->whereNull("users.deleted_at")
        ...
        for ($i = 0; $i <= count($columnsDetails)-1; $i++) {
            ...
            $unity = $unity->addSelect(DB::raw('CONCAT("(",dtunity'.$i.'.value,")",dtunity'.$i.'.name) as '.$cd));
    ...
    public function pittsburgh_report($user_id,$created_user_at){
        $pittsburgh = User::select("p.user_id","users.id as userid")->whereNull("users.deleted_at")
        ...
        for ($i = 0; $i <= count($columnsDetails)-1; $i++) {
            ...
            $pittsburgh = $pittsburgh->addSelect(DB::raw('CONCAT("(",dtp'.$i.'.value,")",dtp'.$i.'.name) as '.$cd));
    ...
    public function violence_damage_report($user_id,$created_user_at){
        $violence_damage = User::select("vd.user_id","users.id as userid")->whereNull("users.deleted_at")
        ...
        for ($i = 0; $i <= count($columnsDetails)-1; $i++) {
            ...
            $violence_damage = $violence_damage->addSelect(DB::raw('CONCAT("(",dtviolencedamage'.$i.'.value,")",dtviolencedamage'.$i.'.name) as '.$cd));
    ...
    public function violence_frequency_report($user_id,$created_user_at){
        $violence_frequency = User::select("vf.user_id","users.id as userid")->whereNull("users.deleted_at")
        ...
        for ($i = 0; $i <= count($columnsDetails)-1; $i++) {
            ...
            $violence_frequency = $violence_frequency->addSelect(DB::raw('CONCAT("(",dtviolencefrequency'.$i.'.value,")",dtviolencefrequency'.$i.'.name) as '.$cd));
    ...
    public function affection_report($user_id,$created_user_at){
        $affection = User::select("a.user_id","users.id as userid")->whereNull("users.deleted_at")
        ...
        for ($i = 0; $i <= count($columnsDetails)-1; $i++) {
            ...
            $affection = $affection->addSelect(DB::raw('CONCAT("(",dtaffection'.$i.'.value,")",dtaffection'.$i.'.name) as '.$cd));
    ...
    public function cicardian_report($user_id,$created_user_at){
        $cicardian = User::select("c.user_id","users.id as userid")->whereNull("users.deleted_at")
        ...
        for ($i = 0; $i <= count($columnsDetails)-1; $i++) {
            ...
            $cicardian = $cicardian->addSelect(DB::raw('CONCAT("(",dtcicardian'.$i.'.value,")",dtcicardian'.$i.'.name) as '.$cd));
