                        ...
                        <div class="p-8">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="http://sgrsaludmental.unimagdalena.edu.co/" target="_blank" class="underline text-gray-900 dark:text-white">
                                        API Salud Mental
                                    </a>
                                </div>
                            </div>
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Sitio de bienvenida para la API de la arquitectura de Salud Mental:
                                    <p>
                                        <strong>API:</strong>&nbsp;
