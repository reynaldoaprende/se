...
import { FormAffectionComponent } from './form-affection.component';
...
@NgModule({
  declarations: [FormAffectionComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
  ...
  exports: [FormAffectionComponent]
})
export class FormAffectionModule { }
