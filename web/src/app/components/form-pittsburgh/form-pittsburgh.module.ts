...
import { FormPittsburghComponent } from './form-pittsburgh.component';
...
@NgModule({
  declarations: [FormPittsburghComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
  ...
  exports: [FormPittsburghComponent]
})
export class FormPittsburghModule { }
